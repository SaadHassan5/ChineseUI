    ...
    return (
        <View style={Styles.container}>
            ...
            <View style={{...Styles.otpView}}>
                ...
                <TouchableOpacity style={{backgroundColor:palette.maalta,borderRadius:WP(10)}}>
                    <Text style={{fontSize:14,fontFamily:fontFamily.semi_bold,color:palette.white,textAlign:'center'}}>驗證</Text>
                </TouchableOpacity>
            </View>
        </View>
    )
