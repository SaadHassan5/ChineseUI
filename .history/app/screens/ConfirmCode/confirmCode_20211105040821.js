...
const ConfirmCode = (props) => {
    return (
        <View style={Styles.container}>
            ...
            <View style={{paddingHorizontal:WP(15),paddingVertical:HP(5),backgroundColor:'white',borderTopRightRadius:WP(4),borderBottomLeftRadius:WP(3),borderBottomRightRadius:WP(3)}}>
                <Otp_input />
            </View>
        </View>
    )
