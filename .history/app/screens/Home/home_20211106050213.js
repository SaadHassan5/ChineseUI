        ...
        <View style={{ flex: 1, backgroundColor: palette.maalta }}>
            ...
            <View style={{ backgroundColor: '#EB4918', flex: 1, borderTopLeftRadius: WP(8), borderTopRightRadius: WP(8) }}>
                ...
                <View style={{ backgroundColor: palette.white, flex: 1, borderTopRightRadius: WP(8), borderTopLeftRadius: WP(8) }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center', paddingHorizontal: WP(8), paddingTop: HP(3) }}>
                        <TouchableOpacity>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center', paddingHorizontal: WP(6), paddingTop: HP(3) }}>
                        <TouchableOpacity>
