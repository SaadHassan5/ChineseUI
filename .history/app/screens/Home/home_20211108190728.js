                ...
                <View style={{ backgroundColor: palette.white, flex: 1, borderTopRightRadius: WP(8), borderTopLeftRadius: WP(8) }}>
                    ...
                    {isMine ?
                        <View style={{ paddingVertical: HP(5), paddingHorizontal: WP(10) }}>
                            <SVGS.cancel onPress={()=>setIsMine(!isMine)} style={{position: 'absolute',right:WP(5),marginTop:HP(2)}}/>
                            <TouchableOpacity onPress={()=>props.navigation.navigate('Appointment')} style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <SVGS.appointment />
