        ...
        <View style={{ ...Styles.container }}>
            ...
            <View style={{...Styles.whiteView}}>
                ...
                <View key={i} style={{paddingHorizontal:WP(10),paddingTop:HP(4)}}>
                    <Text style={{fontFamily:fontFamily.semi_bold,color:palette.black,fontSize:14,lineHeight:14}}>{item.title}</Text>
                    <Text style={{fontSize:12,fontFamily:fontFamily.regular,lineHeight:14}}>{item.date}</Text>
                </View>
                )}
            </View>
        </View>
