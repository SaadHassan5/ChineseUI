            ...
            <View style={{ ...Styles.whiteView, paddingTop: HP(3) }}>
                <ScrollView>
                    ...
                    <View style={{ paddingHorizontal: WP(6), paddingTop: HP(4) }}>
                        ...
                        <View style={{flexDirection:'row',alignItems:'center' }}>
                            <Checkbox status={gender=='male'?'checked':'unchecked'} onPress={()=>setGender('male')} color={palette.maalta}/>
                            <Text style={{...Styles.check,marginRight:WP(3)}}>男</Text>
                            <Checkbox status={gender=='female'?'checked':'unchecked'} color={palette.maalta} onPress={()=>setGender('female')}/>
