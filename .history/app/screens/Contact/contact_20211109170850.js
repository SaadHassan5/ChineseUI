        ...
        <View style={{ ...Styles.container }}>
            ...
            <View style={{ ...Styles.whiteView, paddingTop: HP(2) }}>
                ...
                {CONST.contact.map((item, i) =>
                    <View style={{ flexDirection: 'row', alignItems: 'center', width: WP(80), borderWidth: .5, borderColor: palette.lighBlueBtn,marginTop:HP(3),paddingVertical:HP(1.5),paddingHorizontal:WP(3),borderRadius:WP(2.6) }}>
