        ...
        <View style={{ ...Styles.container }}>
            ...
            <View style={{ ...Styles.whiteView, paddingTop: HP(2) }}>
                ...
                {CONST.contact.map((item, i) =>
                    <View style={{ flexDirection: 'row', alignItems: 'center', width: WP(80), borderWidth: 1, borderColor: palette.lightestGrey }}>
                        <View style={{ backgroundColor: item.backcolor, paddingVertical: WP(4), paddingHorizontal: WP(5) }}>
                            <item.svg />
                        </View>
                        <View>
                            <Text style={{ fontFamily: fontFamily.medium, fontSize: 15, color: '#393939', lineHeight: 29 }}>{item.title}</Text>
                            <Text style={{ fontFamily: fontFamily.medium, fontSize: 15, color: '#393939', lineHeight: 29 }}>{item.contact}</Text>
                        </View>
                    </View>
                )}
            </View>
