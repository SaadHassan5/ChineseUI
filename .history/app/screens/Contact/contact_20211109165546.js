        ...
        <View style={{ ...Styles.container }}>
            ...
            <View style={{ ...Styles.whiteView, paddingTop: HP(2) }}>
                ...
                {CONST.contact.map((item, i) =>
                    <View style={{ flexDirection: 'row', alignItems: 'center',width:WP(60),borderWidth:1,borderColor:palette.lighBlueBtnTitle }}>
                        <View style={{backgroundColor :palette.maalta,}}>
                            <item.svg />
                        </View>
