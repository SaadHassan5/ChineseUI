        ...
        <View style={{ flex: 1, backgroundColor: palette.maalta }}>
            ...
            <View style={{ ...Styles.whiteView }}>
                {CONST.coaches.map((item, key) =>
                    <View key={key} style={{backgroundColor:'#FFFFFF',marginTop:HP(3),alignSelf:'center',borderBottomWidth:1,borderColor:palette.lighBlueBtn,width: WP(80),paddingVertical:HP(.5),paddingHorizontal:WP(3)}}>
                        <Image source={IMAGES.coach1} style={{width: WP(20),height: WP(20),}}/>
                    </View>
                )}
            </View>
        </View>
