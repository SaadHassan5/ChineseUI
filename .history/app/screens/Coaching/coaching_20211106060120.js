        ...
        <View style={{ flex: 1, backgroundColor: palette.maalta }}>
            ...
            <View style={{ ...Styles.whiteView }}>
                {CONST.coaches.map((item, key) =>
                    <View key={key} style={{backgroundColor:'#FFFFFF',marginTop:HP(3),alignSelf:'center',borderWidth:1,borderColor:palette.lighBlueBtn,width: WP(80),paddingVertical:HP(.5),paddingHorizontal:WP(3)}}>
