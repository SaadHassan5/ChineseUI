                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <ScrollView horizontal>
                            {CONST.pokerField.map((item, i) =>
                                <View key={i}>
                                    <Image resizeMode={'stretch'} source={item.img} style={{ width: WP(80), height: HP(23), marginHorizontal: WP(2.5) }} />
                                </View>
                            )}
                        </ScrollView>
                    </View>
                    <Text style={{ ...Styles.titleTxt }}>用科學的方法， 把每一手牌打出最大價值</Text>
                    <Text style={{ paddingHorizontal: WP(10), fontFamily: fontFamily.regular, fontSize: 13, lineHeight: 24,color:'#666666'}}>
