    ...
    return(
        <View style={{ ...Styles.container }}>
            ...
            <View style={{...Styles.whiteView}}>
                ...
                <Text>撲克領域，是一座以「學習推廣」以及「休閒娛樂」為導向的德州撲克競技館。我們採用會員制，提供專業的教學品質與舒適的場館環境。
...
撲克領域志在創造台灣健全的德州撲克職業平台，讓「職業牌手」、「德州撲克教練」成為受人尊重的職業，完善投入穩定的報酬贊助，參與國際大型賽事，讓台灣的職業德州撲克選手，揚名國際。</Text>
            </View>
        </View>
    )
}
