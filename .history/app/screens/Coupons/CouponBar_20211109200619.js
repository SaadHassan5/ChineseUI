...
const CouponBar = (props) => {
    ...
    return (
        <View style={{ ...Styles.container }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center',marginVertical:HP(15),backgroundColor:palette.white, }}>
                <Text style={{fontSize:12,lineHeight:28,fontFamily:fontFamily.regular,color:palette.white}}>請出示此畫面提供櫃台人員掃描</Text>
