...
const CouponBar = (props) => {
    ...
    return (
        <View style={{ ...Styles.container }}>
            ...
            <Text style={{fontSize:12,lineHeight:28,fontFamily:fontFamily.medium,color:palette.white,marginTop:HP(15),textAlign:'center',paddingVertical:HP(.5)}}>請出示此畫面提供櫃台人員掃描</Text>
