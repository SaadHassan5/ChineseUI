        ...
        <View style={{ ...Styles.container }}>
            ...
            <View style={{backgroundColor:palette.white,flex:1,justifyContent:'center',alignItems:'center'}}>
                <View style={{flexDirection:'row',alignItems:'center'}}>
                    ...
                    <TouchableOpacity style={{borderWidth:1,borderColor:palette.maalta,backgroundColor:palette.maalta,marginLeft:WP(5)}}>
                        <Text style={{fontSize:11,fontFamily:fontFamily.regular,padding:WP(1),color:palette.white}}>不接受此協議</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
