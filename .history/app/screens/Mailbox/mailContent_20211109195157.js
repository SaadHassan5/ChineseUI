...
const MailContent = (props) => {
    ...
    return (
        <View style={{ ...Styles.container }}>
            ...
            <View style={{ ...Styles.whiteView, paddingTop: HP(3), borderTopRightRadius: WP(10), borderTopLeftRadius: WP(10), paddingHorizontal: WP(8) }}>
                ...
                <Text style={{fontSize:12,fontFamily:fontFamily.regular,lineHeight:21,color:'#1C2238',paddingLeft:WP(15)}}>{data.detail}</Text>
            </View>
        </View>
    )
}
