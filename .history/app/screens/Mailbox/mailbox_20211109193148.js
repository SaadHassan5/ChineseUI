        ...
        <View style={{ ...Styles.container }}>
            ...
            <View style={{ ...Styles.whiteView,  }}>
                {CONST.mail.map((item, i) =>
                    <TouchableOpacity onPress={()=>props.navigation.navigate('MailContent')} style={{ backgroundColor:item.read?'':'#FFE9E9',flexDirection: 'row', alignItems: 'center',paddingHorizontal:WP(5),paddingTop: HP(3)}}>
