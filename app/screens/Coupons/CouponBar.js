...
const CouponBar = (props) => {
    ...
    return (
        <View style={{ ...Styles.container }}>
            <CustomHeader txt={'我的條碼'} props={props}/>
            <Text style={{fontSize:12,lineHeight:28,fontFamily:fontFamily.medium,color:palette.white,marginTop:HP(15),textAlign:'center',paddingVertical:HP(1)}}>請出示此畫面提供櫃台人員掃描</Text>
            ...
            <View style={{backgroundColor:palette.white,flex:1,alignItems:'center',marginTop:HP(8)}}>
