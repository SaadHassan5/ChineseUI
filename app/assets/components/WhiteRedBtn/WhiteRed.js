...
export const WhiteRed =({txt1,txt2,nav1,nav2})=>{
    return(
        <View style={{flexDirection:'row'}}>
            <TouchableOpacity onPress={nav1} style={{borderColor:palette.maalta,borderRadius:WP(1),borderWidth:1,width:WP(20)}}>
            ...
            <TouchableOpacity onPress={nav2} style={{marginLeft:WP(3),borderRadius:WP(1),borderColor:palette.maalta,borderWidth:1,width:WP(20),backgroundColor:palette.maalta}}>
